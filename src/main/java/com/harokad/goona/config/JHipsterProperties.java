...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "GoonaTira@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "GoonaTira API";

        private String description = "GoonaTira API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "GoonaTira";
