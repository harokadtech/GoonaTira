package com.harokad.goona.crawler.url;
...
public class UrlCrawler {
     ...
     * @throws IOException
     */
    public static void importFilesAtUrl(String url, final String sourceName, final String categoryName, final String exclusionRegex) throws IOException {
        // create parents
        ...
        _importFilesAtUrl(url, sourceId, categoryId, exclusionRegex);
    ...
    private static void _importFilesAtUrl(String url, final String sourceId, final String categoryId, final String exclusionRegex) throws IOException {
